...
git remote add template https://github.com/org/presentation_blackhat_eu_dec_2025.git
```
...
git fetch template
git checkout template/main -- presentation_blackhat_eu_dec_2025/routes/health.py
